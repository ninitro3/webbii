...
function Submit() {
    ...
    let test = "Account Created Successfully🌟🌟\n\nDo you Wish to Display the Registered Data ?";
    if (confirm(test) == true) {
        document.getElementById("name").innerHTML = fName + " " + lName;
        document.getElementById("do").innerHTML = dob;
        // document.getElementById("se").innerHTML = sex;
        document.getElementById("mai").innerHTML = mail;
        document.getElementById("phn").innerHTML = "+91 " + phno;
        document.getElementById("place").innerHTML = "Lives in " + dist + " " + " of " + " " + state;
    } else {
...
function mouseOver() {
    ...
    const name = document.forms['suForm']['fname'].value;
...
function buttonMoveLeft() {
    ...
    button.style.transform = 'translateX(-220%)';
